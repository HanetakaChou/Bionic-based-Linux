...
# glslang
/system/bin/glslangValidator -V cube.vert -x -o generated/cube.vert.inc
/system/bin/glslangValidator -V cube.frag -x -o generated/cube.frag.inc

# include-bin
../../Binary/x86/Release/include-bin lunarg.ppm generated/lunarg.ppm.h
../../Binary/x86/Release/include-bin ../Assets/Lenna/l_hires-ASTC.pvr generated/ll_hires-ASTC.pvr.h
