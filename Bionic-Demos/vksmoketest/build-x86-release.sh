...
/system/bin/glslangValidator -V Smoke.push_constant.vert -x -o Smoke.push_constant.vert.inc
/system/bin/glslangValidator -V Smoke.vert -x -o Smoke.vert.inc
/system/bin/glslangValidator -V Smoke.frag -x -o Smoke.frag.inc
